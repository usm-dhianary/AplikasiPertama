...
class OsmMapFragment : Fragment() {
    ...
    private lateinit var  db: AbsensiDatabase //penambahan
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        db = AbsensiDatabase.getDatabase(requireContext()) //penambahan
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnAbsen = view.findViewById<Button>(R.id.btnAbsen) //penambahan
        ...
        fusedLocationClient.lastLocation.addOnSuccessListener { location ->
            if (location != null) {
                ...
                viewLifecycleOwner.lifecycleScope.launch(Dispatchers.IO) {
                    ...
                    val resultId = db.attendaceDao().insertAttendance(attendace)
